...
try {
  ...
  const providerRequestCountBeforeUpgrade = provider.requests.length;
  ...
  assert.equal(
    ...
    providerRequestCountBeforeUpgrade + 1,
    'upgrade request should short-circuit locally without a second provider round-trip',
  );
