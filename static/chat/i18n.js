...
(function attachRemoteLabI18n(root) {
  ...
  const translations = {
    en: {
      ...
      "settings.apps.note": "Create reusable apps or workflows here. Chat stays lightweight; other apps can attach a first assistant message and extra behavior instructions.",
      ...
      "settings.apps.systemPromptPlaceholder": "Optional behavior instructions for this app",
    ...
    "zh-CN": {
      ...
      "settings.apps.note": "在这里创建可复用的应用或工作流。聊天本身保持轻量，其他应用可以附带第一条助手消息和额外行为说明。",
      ...
      "settings.apps.systemPromptPlaceholder": "这个应用的可选行为说明",
